...
public class UserDAOImpl implements UserDAO {
	...
	public List<User> findAll() {
		...
		String hql = "select distinct u " + "from User u " + "left join fetch u.roles";
	...
	public List<User> findLast(int limit) {
		...
		return session.createQuery(hql).setMaxResults(limit).getResultList();
	}
	...
	public User findOne(int id) {
		...
		String hql = "select distinct u " + "from User u " + "left join fetch u.roles " + "where u.id = :id";

		try {
			return (User) session.createQuery(hql).setParameter("id", id).getSingleResult();
	...
	public User findOne(String email) {
		...
		String hql = "select distinct u " + "from User u " + "left join fetch u.roles " + "where u.email = :email";
