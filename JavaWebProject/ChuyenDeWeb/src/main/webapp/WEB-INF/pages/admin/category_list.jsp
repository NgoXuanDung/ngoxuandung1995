								...
								<tbody>
									<c:forEach items="${categories}" var="category">
										<tr>
											...
											<td>${category.name}</td>
											<td align="center"><a
												href="<c:url value="/admin/category/${category.id}" />">
													${fn:length(category.questions)} </a></td>
											<td align="center"><a
												href="<c:url value="/admin/category/${category.id}/edit" />"
												title="Edit category"> <i class="fa fa-pencil"></i>
											</a></td>
											<td align="center"><a
												href="<c:url value="/admin/category/${category.id}/delete" />"
												title="Delete category"
												onclick="return confirmDelete('category');"> <i
													class="fa fa-trash"></i>
											</a></td>
										</tr>
									</c:forEach>
